...
{
    const char* pszTimestamp = "this project has developed by Pran Pegu(https://github.com/ppegu/)";
    const CScript genesisOutputScript = CScript() << ParseHex("636184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1051200; // (24 * 60) / 2 = 720/day * 365days = 262800blocks/year * 4(halving interval)years = 10,51,200
        ...
        consensus.nPowTargetSpacing = 2 * 60; // 2 minutes block interval
        ...
        genesis = CreateGenesisBlock(1697458017, 2002696362, 0x1e0ffff0, 1, 55 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa80baa0c1807d749e251df73f59f36fa5b2a8c028bff20bd4407c8b30455f083"));
        assert(genesis.hashMerkleRoot == uint256S("0x8e4601e90a6710677ad8911eb4e804eb8cc376f6786ef8cf4e6f1efb0a15f2bd"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("18.233.64.36", "18.233.64.36", true));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xa80baa0c1807d749e251df73f59f36fa5b2a8c028bff20bd4407c8b30455f083"))
        ...
        chainTxData = ChainTxData{
            ...
            1697458017, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1697458017, 360745, 0x1e0ffff0, 1, 55 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xafbbcf2ea1060206dbc032c299a5c44174f067c4ade53794d95dbc2f4544b406"));
        assert(genesis.hashMerkleRoot == uint256S("0x8e4601e90a6710677ad8911eb4e804eb8cc376f6786ef8cf4e6f1efb0a15f2bd"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("18.233.64.36", "18.233.64.36"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xafbbcf2ea1060206dbc032c299a5c44174f067c4ade53794d95dbc2f4544b406")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1697458017, 2, 0x207fffff, 1, 55 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x88665765af086e13cd0dbd8fde831736cec810d9614bbe89fcc9250e87c91fe5"));
        assert(genesis.hashMerkleRoot == uint256S("0x8e4601e90a6710677ad8911eb4e804eb8cc376f6786ef8cf4e6f1efb0a15f2bd"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x88665765af086e13cd0dbd8fde831736cec810d9614bbe89fcc9250e87c91fe5"))
        };
