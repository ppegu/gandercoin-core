...
const char* BIP71_MIMETYPE_PAYMENT = "application/gandercoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/gandercoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/gandercoin-paymentrequest";
